...
public class Board {
    ...
    private static ArrayList <ChanceCard> cards = new ArrayList<>();
    ...
    private static String createChanceCards(String[] data) {
        String txt = "";
        ...
        for (String s : data) {
            ...
            cards.add(new ChanceCard(txt, cost, income));
        }
        return txt;
    }
  static ChanceCard getChanceCard(){
        ChanceCard c1 = cards.get(index);
        index++;
        return c1;
}
